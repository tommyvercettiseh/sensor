...
public class CombatOverlay extends Overlay
{
	...
	@Inject
	public CombatOverlay(SensorPlugin plugin, SensorConfig config)
	{
		this.plugin = plugin;
		this.config = config;
	...
	public Dimension render(Graphics2D graphics)
	{
		...
		boolean active = plugin.isCombat();
		drawCard(graphics, width, height, "COMBAT", active ? "ACTIVE" : "OFF", active);
